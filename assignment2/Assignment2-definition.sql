...
VALUES ((SELECT id FROM category_tbl WHERE name = 'phone' AND subcategory = 'maybe a tablet?'), "Samsung Atlas", "1970-1-2", "1");
...
-- isbroken - False
INSERT INTO device(cid, name, received, isbroken)
VALUES ((SELECT id FROM category_tbl WHERE name = "tablet" AND subcategory = "but kind of a laptop"), "Nokia", "1999-05-06", "0");
...
-- isbroken - False
INSERT INTO device(cid, name, received, isbroken)
VALUES ((SELECT id FROM category_tbl WHERE name = "tablet" AND subcategory = "ereader"), "jPad", "2005-11-18", "0");
